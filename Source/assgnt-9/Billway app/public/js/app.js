...
imageApp.controller("HomePageController", function($scope, $state,$http,$cordovaBarcodeScanner,$cordovaCamera) {
    ...
    $scope.user = "Hello.. "+username;
    $scope.mobile = "Mobile No. : "+mobileNum
    //alert("user : "+user);
    ...
    $scope.createUser = function() {
       ...
       // alert("signup");
        ...
        if(firstname==""){
            ...
            $http({
            type: "GET",
            url : 'https://api.mongolab.com/api/1/databases/mouni/collections/asecollection?q={mobile:\''+mobile+'\'}&apiKey=_6UAHYJQmcDCwNpPJL-8U3eDJV6dFVdq',
 ...
 var name = localStorage.getItem("name");
    ...
    // alert(data[0]._id.$oid);
      if (name == data[0].name ) {
          ...
          $http({
              method: 'PUT' ,   
        url: 'https://api.mongolab.com/api/1/databases/mouni/collections/asecollection/'+data[0]._id.$oid+'?apiKey=BRAZaLJlcYe5QBqAEzUAhchG6H_jQx1k',
		 data: JSON.stringify( { "$set" : { "password" : pw } } ),
